...
export let listasDeCompras = [];

export let produtosCompras = [];
...
export const mostraListasCompras = () => {
...
export const alterarListaCompras = (lista) => {
...
export const mostraProdutosCompra = () => {
...
export const habilitaCampo = (idCampo) => {
